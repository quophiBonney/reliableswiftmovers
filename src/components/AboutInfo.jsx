  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-16 mb-10">
      <div>
        <img
          src={
            "https://images.pexels.com/photos/6169010/pexels-photo-6169010.jpeg"
          }
          alt=""
      ...
      <div className="space-y-4">
        ...
        <h4 className="text-3xl font-bold">
          We are leader in moving companies in Canada
        </h4>
        <p className="text-base">
          All Canada Van Lines (ACVL), among top moving companies in Alberta,
          provides tailored relocations across Canada with personalized
          attention. Our specialists securely pack, transport, and unpack using
          top techniques. With 2000+ satisfied customers, trust us for
