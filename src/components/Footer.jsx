...
const Footer = () => {
  return (
    <footer className="bg-black/5">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 px-4 md:px-8 lg:px-16 text-black">
        <div className="mt-10">
      ...
      <div className="text-center mb-10 mt-10 px-4 md:px-8 lg:px-16">
        <hr />
        <br />
        <p clasName="mt-5 mb-5">All right reserved &copy; 2026</p>
        <br />
      </div>
    </footer>
  );
